...
// Persist joined rooms across reloads so the sidebar feels stable.
const ROOMS_KEY = "chat.joined_rooms";
...
export default function ChatPage() {
  ...
  const [joinedRooms, setJoinedRooms] = useState<string[]>(loadRooms);
  ...
  // Persist joined rooms whenever they change.
  useEffect(() => {
    saveRooms(joinedRooms);
  }, [joinedRooms]);
